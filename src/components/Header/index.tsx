...
import { getCookie } from "@/utils/cookiesHandler"; // Import the getCookie function
...
const Header = () => {
  ...
  // Re-run checkUserAuth on pathname change
  useEffect(() => {
    checkUserAuth(); // Check authentication status whenever the pathname changes
  }, [pathname]);
        ...
        <div className="container">
          <div className="relative -mx-4 flex items-center justify-between">
            <div className="w-60 max-w-full px-4 xl:mr-12">
              ...
              >
                <Image
                  src="/images/logo/logo_light_mode.png"
                  alt="logo"
                  width={140}
                  height={30}
                ...
                />
                <Image
                  src="/images/logo/logo_dark_mode.png"
                  alt="logo"
                  width={140}
                  height={30}
